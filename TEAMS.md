...
| content/patterns | proposed | [current discussion](https://github.com/open-gitops/project/discussions/177) | <ul><li>[@christianh814](https://github.com/christianh814)</li><li>[@crenshaw-dev](https://github.com/crenshaw-dev)</li><li>[@samueltauil](https://github.com/samueltauil)</li><li>[@scottrigby](https://github.com/scottrigby)</li><li>[@roberthstrand](https://github.com/roberthstrand)</li></ul> |

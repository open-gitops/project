...
<p><img src="/workspaces/project/images/OpenGitOps logo icon color.png" alt="OpenGitOps logo icon color" width="150"></p>
...
| <img src="/workspaces/project/images/OpenGitOps logo icon color.png" alt="OpenGitOps logo icon color" width="100"> | [project](https://github.com/open-gitops/project) | Top-level information about the OpenGitOps project (this repo) |
